...
export class DropoffBox 
{
  ...
  {   
    ...
    this.store_material = this.mesh.material[4];
  ...
  select()
  {
    const oldMat = this.mesh.material[4];
    this.mesh.material[4] = new THREE.MeshLambertMaterial({
      color: "lightgray",
      map: oldMat.map} );
  }
  ...
  deselect()
  {
    this.mesh.material[4] = this.store_material;
  }
