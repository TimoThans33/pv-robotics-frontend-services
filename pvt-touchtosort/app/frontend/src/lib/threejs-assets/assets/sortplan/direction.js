...
export class Direction {
  ...
  loadObject() {
    ...
    this.addEventListener("touchClick", this.touchClick.bind(this));
    this.addEventListener("click", this.touchClick.bind(this));
  ...
  touchClick()
  {
    var box = this.boxes[this.direction];
    box.select();
    let func = this.store.getTargetFunc();
    var infeed = this.store.getInfeed();
    func(this.direction, infeed);
    setTimeout(function(){
      box.deselect();
    }, 100);
  }
